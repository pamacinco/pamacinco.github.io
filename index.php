...
<head>
  <meta charset="utf-8">
  <title>Miami Community | Web</title>
  ...
  <link href="https://media.discordapp.net/attachments/814582038698393680/953665161108029481/miamicommunityblanco.png?width=687&height=687" rel="shortcut icon" type="image/x-icon">
...
<body class="body">
  <div class="content">
    <div class="container-2 w-container">
      <div>
        <a data-w-id="fd97c34e-0ce6-5332-f83e-8075cd6b6278" style="opacity:0" href="https://discord.gg/miamicommunity" class="button w-button">CONECTARSE</a>
      </div>
    </div>
    <div class="header-logo w-container">
      <div><img src="images/BUBBLE.png" loading="lazy" srcset="https://media.discordapp.net/attachments/814582038698393680/953665161108029481/miamicommunityblanco.png?width=687&height=687" sizes="120px" alt="" class="image"></div>
    </div>
    <div class="container-3 w-container">
      <div class="w-layout-grid grid">
        <div id="w-node-b697e036-735e-08c0-bc5b-b13cca0d2141-9d8417b5">
          <h1 data-w-id="5f1a2e51-a3ab-5529-5457-621fa6de47d5" style="opacity:0" class="heading-2">Miami Community</h1>
          <div data-w-id="7d10a558-c8cd-9ea6-718c-d1ba93f2dfa5" style="opacity:0" class="text-block-2">NUEVA EXPERIENCIA DE ROL!</div>
          <a data-w-id="8cbfab13-cb16-26d0-f544-6175ac9f5780" style="opacity:0" href="https://discord.gg/miamicommunity" class="button-2 w-button">DISCORD</a>
          <div class="html-embed w-embed">Jugando Ahora: <?php
$file = file_get_contents('http://45.137.17.195:30120/dynamic.json');
    ...
    <div class="container-4 w-container">
      <div class="w-layout-grid grid-2">
        <div id="w-node-_3a9cc200-c06c-8fed-6e08-a4b490a70910-9d8417b5">
          <div data-w-id="8e16d89c-cfaf-14dd-a274-405e794d9f68" style="opacity:0" class="text-block">NUESTRAS REDES</div>
        </div>
        <div id="w-node-abbf86c0-3ac5-ca79-cea8-2f6425308db3-9d8417b5" data-w-id="abbf86c0-3ac5-ca79-cea8-2f6425308db3" style="opacity:0" class="div-block">
          <a href="https://discord.gg/miamicommunity" class="button-6 w-button"><br>‍</a><img src="images/Design-ohne-Titel---2022-11-06T235554.447.png" loading="lazy" width="75" srcset="images/Design-ohne-Titel---2022-11-06T235554.447-p-500.png 500w, images/Design-ohne-Titel---2022-11-06T235554.447.png 500w" sizes="75px" alt="">
        </div>
        ...
        <div id="w-node-b8cc9362-05d2-b704-fe25-ac8f58f13102-9d8417b5" data-w-id="b8cc9362-05d2-b704-fe25-ac8f58f13102" style="opacity:0" class="div-block">
          <a href="https://www.instagram.com/miamicommunityrp/" class="button7 w-button"><br>‍</a><img src="images/Design-ohne-Titel---2022-11-06T235753.465.png" loading="lazy" width="75" srcset="images/Design-ohne-Titel---2022-11-06T235753.465-p-500.png 500w, images/Design-ohne-Titel---2022-11-06T235753.465.png 500w" sizes="75px" alt="">
        </div>
      </div>
    </div>
  </div>
